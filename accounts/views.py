...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            to_email = email
            sand_email = EmailMessage(mail_subject, message, to=[to_email])
            sand_email.send()
          # messages.success(request, 'Thank you for registration with us. We have sent you a verification email address. please verify it. ')
